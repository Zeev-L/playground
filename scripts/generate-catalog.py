...
UPSTREAM = {
    ...
    "_local": ("Zeev-L (original)", "Zeev-L", "—", "https://github.com/Zeev-L/skills-marketplace"),
}
...
def main():
    ...
    for pl in mkt["plugins"]:
        ...
        if cdir is None:                                   # local plugin (text-tools)
            ...
            src_repo = "Zeev-L/skills-marketplace"
        else:
    ...
    md = [f"# Skills catalog — {data['total_skills']} skills across {data['total_plugins']} plugins",
          ...
          "Browse interactively: https://zeev-l.github.io/skills-marketplace/", "",
