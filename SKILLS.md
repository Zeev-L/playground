...
Upstream: **Zeev-L (original)** · License: — · Install: `claude plugin install text-tools@zeev-playground`
...
Upstream: **addyosmani/agent-skills** · License: MIT · Install: `claude plugin install agent-skills@zeev-playground`
...
Upstream: **garrytan/gstack** · License: MIT · Install: `claude plugin install gstack@zeev-playground`
...
Upstream: **menkesu/awesome-pm-skills** · License: MIT · Install: `claude plugin install awesome-pm-skills@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-product-discovery@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-product-strategy@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-toolkit@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-execution@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-market-research@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-ai-shipping@zeev-playground`
...
Upstream: **phuryn/pm-skills** · License: MIT · Install: `claude plugin install pm-data-analytics@zeev-playground`
...
Upstream: **coreyhaines31/marketingskills** · License: MIT · Install: `claude plugin install marketing-skills@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install x@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install gdoc-math@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install find-session@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install setup-pulse@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install claude-reviewer@zeev-playground`
...
Upstream: **omriariav/omri-cc-stuff** · License: MIT · Install: `claude plugin install skill-reviewer@zeev-playground`
