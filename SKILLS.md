# Skills catalog — 223 skills across 18 plugins
...
## marketing-skills  ·  _PMM / Biz dev_  (46 skills)
...
| `marketing-loops` | Corey Haines | When the user wants to set up a recurring, self-running marketing workflow — a repeatable loop an AI agent runs on a cadence (weekly, daily, on a trigger) rather than a one-off task. Also use when the user mentions 'marketing loop,' 'recurring marketing workflow,' 'automate my… |
